...
st.divider()
st.subheader("📝 Советы для лучшего результата")
st.markdown("""
1. Снимайте объект на контрастном фоне
2. Убедитесь, что мусор занимает не менее 70% кадра
3. Избегайте бликов и сильных теней
4. Для мелких объектов используйте макросъемку
5. Избегайте фотографировать несколько объектов одновременно
""")