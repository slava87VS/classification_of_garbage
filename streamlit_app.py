...
st.title("🗑️ ЭкоСкан: Определение класса утилизации мусора")
...
st.markdown("""
**ЭкоСкан** - социальный проект, созданный для повышения экологической сознательности и упрощения сортировки отходов. 
